"""
Test script to verify the integration of streamlined prompts.

This script creates a sample AdventureState for the first chapter and
generates content using the LLM service to confirm that the streamlined
...
async def test_streamlined_integration():
    """Test the integration of streamlined prompts."""
    # Configure logging
    ...
    logger.info("Generating first chapter content using streamlined prompts...")
    ...
    logger.info("Check the logs above to verify that streamlined prompts were used.")


if __name__ == "__main__":
    asyncio.run(test_streamlined_integration())
